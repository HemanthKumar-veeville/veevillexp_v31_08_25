  ...
  return (
    ...
    >
      ...
      <div className="lg:hidden px-4 sm:px-6 md:px-8 flex flex-col justify-center gap-4 sm:gap-6 md:gap-8 h-[100dvh] max-h-[100dvh] py-4 sm:py-6 md:py-8">
        ...
        <img
          className={`w-full h-auto max-h-[45dvh] sm:max-h-[45dvh] md:max-h-[50dvh] object-contain ${getAnimationClasses(
            0
          )}`}
      ...
      <div className="hidden  lg:w-full lg:px-14 max-w-[1280px] mx-auto lg:py-[90px] lg:py-auto lg:flex lg:flex-col lg:items-start lg:justify-center">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 gap-8 items-center">
              ...
              >
                <UpdatedDescription>
                  ...
                  <span>
                    ...
                    we will help you to question without fear, unwind your
                    biases, view your challenges with fresh eyes and attack them
                    with fresh energy.
                  </span>
                </UpdatedDescription>
              </div>
            ...
            <div
              className={`flex justify-center lg:justify-end ${getAnimationClasses(
                1
              )}`}
              style={getAnimationDelay(1)}
            >
