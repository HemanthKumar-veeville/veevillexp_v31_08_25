          ...
          >
            <div className="embla__container flex">
              {methodologyData.map((item, index) => (
                ...
                >
                  <div className="relative flex flex-col items-start justify-center gap-2 sm:gap-4 md:gap-6 bg-white rounded-lg p-4 shadow-sm h-[64vh] sm:h-[70vh] md:h-[75vh]  border border-gray-200">
